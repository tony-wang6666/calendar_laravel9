...
<div class="w-288 mx-auto mt-4 select-none">
    <div class="bg-blue-400 p-2 rounded-t-lg flex items-center justify-between ">
        ...
        <a href="{{url('crm/contribution_import_check')}}" class="bg-gray-500 hover:bg-gray-400 text-white font-bold py-2 px-4 border-gray-600 hover:border-gray-500 rounded shadow-xl">回列表</a>
    </div>
    
    <div class="bg-blue-200 text-lg font-bold text-center select-none">
        <form action="{{url('crm/contribution_import')}}" method="post" enctype="multipart/form-data">
            @csrf
