...
<div class="w-288 mx-auto mt-4 select-none">
    ...
    <div class="bg-blue-200 text-lg font-bold text-center select-none">
        <div class="flex ">
            ...
            <div class="m-2">
                <a href="{{url('crm/insurance_information_import')}}" class="bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-r-4 border-green-600 hover:border-green-500 rounded shadow-xl">轉入資料</a>
                <a href="{{url('crm/insurance_information_export')}}" class="bg-gray-500 hover:bg-gray-400 text-white font-bold py-2 px-4 border-b-4 border-r-4 border-gray-600 hover:border-gray-500 rounded shadow-xl">匯出資料</a>
            </div>
        </div>
        <div class="">
...
<script>
    function insurance_information_check(year,month){
        $.ajax({
            type:'get',
            url:'{!!URL::to('crm/insurance_information_check')!!}',
    ...
    $(document).ready( function(){
        ...
        insurance_information_check(year,month)
